...
//				alert(count); /* for debugging purposes */
  ...
  return 'Displaying contact information...'
}

function education() {
  clearContent()
  document.getElementById('education').style.display = 'inline'
  return 'Displaying education background...'
}
...
export function App(props) {
  ...
  return (
    <Fragment>
      ...
      <div id='welcome'>Welcome to Abhisek Terminal! Press a key to continue...</div>
      <div id='welcome2'>--- Welcome to Abhisek Terminal! ---</div>
      <br /><br />
